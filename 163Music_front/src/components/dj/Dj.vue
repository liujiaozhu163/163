            ...
            <div class="jiemu" v-for="(items,index) in djRadios" :key="index">
              <router-link :to="{name:'diantai',params:{id:items.id}}">
                ...
                <div class="tuijianwenzi ziyanse">
                  ...
                  <p class="zuozhe">
                    <el-link class="zuozhe" type="info">{{items.name}}</el-link>
                  </p>
